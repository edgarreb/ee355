...
void Network::saveDB(string filename){
	...
	while(ptr != NULL) 
	{
		output_file << ptr->l_name << ", " << ptr->f_name << endl;
		output_file << ptr->birthdate->get_date() << endl;
		output_file << ptr->email->get_contact() << endl;
		output_file << ptr->phone->get_contact() << endl;
		output_file << "------------------------------" << endl;
